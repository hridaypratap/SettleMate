...
function GroupDetails({
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      if (navigationTarget === 'settlements') {
        settlementsSectionRef.current?.scrollIntoView({
          behavior: 'smooth',
          block: 'start',
        })
      }

      if (navigationTarget === 'settings') {
  ...
  return (
    <main className="dashboard-main">
      ...
      >
        ...
        <div className="section-header">
          ...
          <div>
            ...
            <p>
              Minimum transactions needed to settle the group.
            </p>
          </div>
      ...
      <section
        className="dashboard-section group-expenses-section"
        ...
        <div className="modal-overlay">
          ...
          <div className="create-group-modal">
            ...
            <p>
              ...
              and all its expenses. This action cannot
              be undone.
            </p>
